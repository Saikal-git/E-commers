...
const BasketCard = ({ el }) => {
  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-4 font-semibold text-[20px] text-gray-900 dark:text-white">
        {el.name}
      </td>
      ...
      <td className="px-6 py-4">
        <a
          ...
          className="font-medium text-2xl text-red-600 dark:text-red-500 hover:underline"
        >
          Remove
        </a>
      </td>
